     ...
     <footer class="footer-section section bg-dark">
				...
				<div class="container">
					<div class="row row-25">
						...
						<div class="footer-widget col-lg-5 col-md-6 col-sm-6 col-12 mb-40 mb-xs-35">
							<h4 class="title"><span class="text">SHOP</span></h4>
							<ul class="ft-menu">
								<li><a href="https://www.eighteenb.com/silk-facial-moisturizers/defend-nourish-eye-cream">Defend + Nourish Eye Cream</a></li>								
							...
							<ul class="ft-menu">
								...
								<li><a href="https://blog.eighteenb.com/">Eighteen B Journal: The Lab</a></li>								
						...
						<div class="footer-widget subscribe col-lg-4 col-md-6 col-sm-6 col-12 mb-40 mb-xs-35">
							...
							<ul class="address">
								<li>Signup to receive 20% off your first order</li>
								<li>
			...
			<div class="newsletter-popup-area" id="newsletter-popup-area">
				<div class="newsletter-popup-content-wrapper">
						...
						<div class="newsletter-popup-content text-center test">
							...
							<div class="w-50 float-left w-sm-100">
								...
								<div class="modal-body">
										...
										<h2>Enjoy 20% Off</h2>
										<p>Signup to receive 20% off your first order and be the first to know about our latest product news and exclusive offers</p>
