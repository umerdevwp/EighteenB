			...
			<div class="header-top ">
				<div class="container-fluid ">
					<div class="row align-items-center">
														...
														<div class="nav-links px-6">
															...
															<div class="submenu shop-submenu">
																<div class="back shop-back">
																	...
																	<ul class="list-reset">
                                  <li class="submenu-item flex-col sets eye">
																			
																			  <h2 class="text-xxs mb-1 font-color-orange" style="font-size:10px;" >NEW!</h2> 
																			  <a href="https://www.eighteenb.com/silk-facial-moisturizers/defend-nourish-eye-cream" class="submenu-link flex-col font-color-orange">Defend + Nourish Eye Cream</a>
																		</li>
																	<li class="submenu-item flex-col sets">
																			
																			  <h2 class="text-xxs mb-1" style="font-size:10px;" >NEW!</h2> 
																			  <a href="https://www.eighteenb.com/silk-facial-moisturizers#sets" class="submenu-link flex-col">Sets to Save</a>
																		</li>
													...
													<div id="sub-shop" class="dropdown" style="">
														<div class="dropdown__inner">
															<figure class="dropdown__figure" style="height: 450px;">
																...
																<img src="<?php echo get_template_directory_uri(); ?>/assets/images/All.png" alt="sub-shop" class="dropdown__image visible" data-v-63085110="">
																...
																<img src="<?php echo get_template_directory_uri(); ?>/assets/images/All.png" alt="1" class="dropdown__image product-5 image-1280" data-v-63085110="">
																<img src="<?php echo get_template_directory_uri(); ?>/assets/images/All.png" alt="1" class="dropdown__image product-5 image-1024" data-v-63085110="">
																<img src="<?php echo get_template_directory_uri(); ?>/assets/images/All.png" alt="1" class="dropdown__image product-5 image-728" data-v-63085110="">
															...
															<div class="dropdown__content">
																...
																<li class="dropdown-item gift-list">
																		...
																		<h2 class="text-xxs mb-1" style="font-size:10px;" >NEW!</h2> 
																		<a href="https://www.eighteenb.com/silk-facial-moisturizers/defend-nourish-eye-cream" class="dropdown-item__link product-link-item-5 font-color-orange" >
																			Defend + Nourish Eye Cream
																		</a>
																	</li>
                                  <li class="dropdown-item" >
																		<h2 class="text-xxs mb-1" style="font-size:10px;" >NEW!</h2> 
																		<a href="https://www.eighteenb.com/silk-facial-moisturizers#sets" class="dropdown-item__link product-link-item-4" >
																			Sets to Save
																		</a>
																	</li>
																	<li class="dropdown-item" >
								...
								<!---Promobar Start-->
								<div class="promo-bar promo-bar-bg banner-text text-center">
										<div class="promo"><a href="https://www.eighteenb.com/silk-facial-moisturizers">Save 20% on orders of $100 or more. <span>Enter<strong> FIRST20</strong> (excludes sets and bundles)</a></span></div>
										<div class="promo"><a href="https://www.eighteenb.com/silk-facial-moisturizers"><strong>FREE ground shipping!</strong></a></div>
								</div>
					</div>
				</div>
			</div>
