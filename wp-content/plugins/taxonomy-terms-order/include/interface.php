    ...
    function TOPluginInterface()
        {
            ...
            <div class="wrap">
                ...
                <h2><?php _e( "Category Order", 'taxonomy-terms-order' ) ?></h2>
                    ...
                    if (count($post_type_taxonomies) > 1)
                        {
                            ...
                            <h2 class="subtitle"><?php echo ucfirst($post_type_data->labels->name) ?> <?php _e( "Categories", 'taxonomy-terms-order' ) ?></h2>
