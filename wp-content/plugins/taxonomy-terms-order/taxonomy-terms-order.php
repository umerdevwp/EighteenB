    ...
    function TOPluginMenu() 
        {
            ...
            add_options_page('Categories Order', '<img class="menu_tto" src="'. TOURL .'/images/menu-icon.png" alt="" />' . __('Categories Order', 'taxonomy-terms-order'), 'manage_options', 'to-options', 'to_plugin_options');
            ...
            foreach( $post_types as $post_type) 
                {
                    ...
                    if ($post_type == 'post')
                        add_submenu_page('edit.php', __('Categories Order', 'taxonomy-terms-order'), __('Categories Order', 'taxonomy-terms-order'), $capability, 'to-interface-'.$post_type, 'TOPluginInterface' );
                        elseif ($post_type == 'attachment')
                        add_submenu_page('upload.php', __('Categories Order', 'taxonomy-terms-order'), __('Categories Order', 'taxonomy-terms-order'), $capability, 'to-interface-'.$post_type, 'TOPluginInterface' );   
                        else
                        add_submenu_page('edit.php?post_type='.$post_type, __('Categories Order', 'taxonomy-terms-order'), __('Categories Order', 'taxonomy-terms-order'), $capability, 'to-interface-'.$post_type, 'TOPluginInterface' );
                }
        }
